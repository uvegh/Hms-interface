                        ...
                        <div className="  found-patient-details  col-lg-12 col-md-10 m-auto mt-1 rounded p-5">
                            ...
                            <div className="row g-3 rounded border border-light p-3">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <p className='bg-white rounded p-2' >{currentEmpId?.email} </p>
                                </div>
                                ...
                                <div className="col-md-6">
                                    ...
                                    <p className='bg-white rounded p-2 ' style={{ textTransform: 'uppercase' }}>{currentEmpId?.gender}</p>
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor='' className="form-label">PHONE</label>
                                    <p className='bg-white rounded p-2 ' style={{ textTransform: 'uppercase' }}>{currentEmpId?.phone}</p>
                                </div>
