...
const Dp = () => {
  ...
  const submitPrescription = (e) => {
    e.preventDefault();
    axios.post("http://localhost:3001/prescription", prescription).then((res)=>{
  ...
  const getPrescription = async () => {
    let response = await axios.get("http://localhost:3001/prescription").then((res)=>{
            ...
            <div className="presForm4">
              <div>
                ...
                <input
                  ...
                  placeholder="+"
                  onChange={(e)=> setPrescription({...prescription, drug_id:e.target.value})}
